	...
	public class lab4 {
	   ...
	   static {
	       // System.setProperty("webdriver.chrome.driver", "C:\\Users\\Mindaugas\\Desktop\\Eclipse\\chromedriver.exe");
	   ...
	   public void setUp() {
	       ChromeOptions options = new ChromeOptions();
	       options.addArguments("--remote-allow-origins=*");
	       // Ensure the driver is set up here and not reused from a static context if it might have been quit.
	       driver = new ChromeDriver(options); 
	       wait = new WebDriverWait(driver, Duration.ofMillis(20000));
	   ...
	   public static void register(){
	      ...
	      driver.findElement(By.xpath("//input[@id=\"FirstName\" and @class=\"text-box single-line\"]")).sendKeys(lab4.firstname);
	      driver.findElement(By.xpath("//input[@id=\"LastName\" and @class=\"text-box single-line\"]")).sendKeys(lab4.lastname);
